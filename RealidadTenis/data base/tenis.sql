...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-10-2021 a las 17:08:51
...
CREATE TABLE `patrocinador` (
  `id_patrocunador` int(11) NOT NULL,
...
ALTER TABLE `patrocinador`
  ADD PRIMARY KEY (`id_patrocunador`),
...
--
ALTER TABLE `patrocinador`
  MODIFY `id_patrocunador` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `sponsor`
  ...
  ADD CONSTRAINT `id_patrocinador` FOREIGN KEY (`id_patrocinador`) REFERENCES `patrocinador` (`id_patrocunador`);
COMMIT;
