 ...
 * @author Agostina
 */
public class VistaVerPatrocinadores extends javax.swing.JInternalFrame {
     ...
     */
    public VistaVerPatrocinadores(MenuPrincipal menu, PatrocinadorData pd) {
        initComponents();
        
        this.menu = menu;
        this.patrocinadorData = pd;
        modelo = new DefaultTableModel();
        
        patrocinadores = (ArrayList<Patrocinador>) patrocinadorData.obtenerPatrocinadores();
        patrocinadoresActivos = (ArrayList<Patrocinador>) patrocinadorData.obtenerPatrocinadoresActivos();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Todos los Patrocinadores");
        ...
        jCheckBoxActivos.setText("Ver patrocinadores disponibles");
    ...
    private void llenarTablaTodos() {
        for (Patrocinador p : patrocinadores) {
            modelo.addRow(new Object[]{p.getIdPatrocinador(), p.getMarca(), p.isActivo()});
        }
    }
    
    private void llenarTablaActivos() {
        for (Patrocinador p : patrocinadoresActivos) {
            modelo.addRow(new Object[]{p.getIdPatrocinador(), p.getMarca(), p.isActivo()});
        }
    }
